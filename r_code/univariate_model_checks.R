...
# Sn
png('~/Dropbox/ISAR Meta-analysis/new_Sept2020/figures/Sn_resid.png',width = 1024, height = 768)
par(mfrow=c(2,3))
...
# Spie
png('~/Dropbox/ISAR Meta-analysis/new_Sept2020/figures/Spie_resid.png',width = 1024, height = 768)
par(mfrow=c(2,3))
