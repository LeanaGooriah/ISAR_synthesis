...
data_path <- paste(work_dir,"/data/ISAR_datasets",sep="")
...
library(readr)
env_file <- read_csv("data/env_file.csv")
...
# Join env file with diversity file
  ...
  save(all_ISAR, file = paste(getwd(), "/data/diversity_global_synthesis_with_area_NEW.Rdata",sep=""))
